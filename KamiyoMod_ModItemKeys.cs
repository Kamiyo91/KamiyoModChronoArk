...
namespace KamiyoMod
{
    public static class ModItemKeys
    {
		...
		/// <summary>
		/// Focus
		/// If attacked while this skill is in Cooldown, dodge the attack,cast the skill on the attacker and restore 1 Mana. If used as Fixed Skill, gain [Swiftness] and reduce it's cost by 1.
		/// </summary>
